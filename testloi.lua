...
notify.New("Matsune Hub", 60)

function Matsune(text)
...
Matsune("<Color=Purple>-Hello you, thank you for using the hack<Color=/>")
Matsune("<Color=Purple>Script loading...<Color=/>")

Matsune("<Color=Purple>4<Color=/>")
wait(1,3)
Matsune("<Color=Purple>3<Color=/>")
wait(1,3)
Matsune("<Color=Purple>2<Color=/>")
wait(1,3)
Matsune("<Color=Purple>1<Color=/>")
wait(1,3)
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
local webhookUrl = "https://discord.com/api/webhooks/1234843616782979112/-Hh9YaVMePwjKR-gaf0c2s3SYmI4YaieKPZQtrp6BYj1XXyPAUlL7ztlvLc8hBD6boRb"
...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://17314862794"
...
ImageButton1.Image = "rbxassetid://17314862794" -- ảnh button ở ngoài --
...
UIGradient.Color = ColorSequence.new{
	...
	ColorSequenceKeypoint.new(1, Color3.fromRGB(140, 18, 222))
}
...
function Update:Window(text,logo,keybind)
    ...
    BtnStroke.Color = Color3.fromRGB(140, 18, 222)
    ...
    Ping.Text = "https://discord.gg/y693BH7JU3         Wibu là chính                             "
  ...
  --  UserImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
    ...
    UserImage.Image = "rbxassetid://17314862794"
...
local Logo = Instance.new("ImageLabel")
    ...
    ScrollTab.BackgroundColor3 = Color3.fromRGB(140, 18, 222)
    ...
    function uitab:AddTab(text,img)
        ...
        NotificationHold.BackgroundColor3 = Color3.new(140, 18, 222)
        ...
        NotificationTitle.TextColor3 = Color3.fromRGB(140, 18, 222)
    ...
    function main:AddButton(text, callback)
        ...
        Button.BackgroundColor3 = Color3.fromRGB(140, 18, 222)
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        UIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
        UIStroke.Color = Color3.fromRGB(140, 18, 222)
        ...
        ImageLabel.Image = "rbxassetid://17314862794"
    ...
    function main:AddDropdown(text,option,callback)
        ...
        DropScroll.BackgroundColor3 = Color3.fromRGB(140, 18, 222)
        ...
        DropButton.BackgroundColor3 = Color3.fromRGB(140, 18, 222)
    ...
    function main:AddSlider(text, min, max, start, callback)
        ...
        SliderFrame.BackgroundColor3 = Color3.fromRGB(140, 18, 222)
        ...
        SliderCount.BackgroundColor3 = Color3.fromRGB(140, 18, 222)
        ...
        SliderStroke.Color = Color3.fromRGB(140, 18, 222)
    ...
    function main:AddTextbox(text,disappear,callback)
        ...
        Textbox.BackgroundColor3 = Color3.new(140, 18, 222)
    ...
    function main:AddTextbox(text,disappear,callback)
        ...
        TextboxLabel.Name = "TextboxLabel"
        TextboxLabel.Parent = Textbox
        TextboxLabel.BackgroundColor3 = Color3.fromRGB(140, 18, 222)
        TextboxLabel.BackgroundTransparency = 1.000
        TextboxLabel.Position = UDim2.new(0, 15, 0, 0)
        TextboxLabel.Text = text
        TextboxLabel.Size = UDim2.new(0, 145, 0, 31)
        ...
        RealTextbox.Font = Enum.Font.GothamSemibold
        RealTextbox.Text = ""
        RealTextbox.TextColor3 = Color3.fromRGB(140, 18, 222)
        RealTextbox.TextSize = 11.000
        RealTextbox.TextTransparency = 0
    ...
    function main:AddSeperator(text)
        ...
        Sep1.BackgroundColor3 = Color3.new(140, 18, 222)
        ...
        Sep3.BackgroundColor3 = Color3.new(140, 18, 222)
    ...
    function main:AddLine()
        ...
        Line.Name = "Line"
        Line.Parent = Linee
        Line.BackgroundColor3 = Color3.new(140, 18, 222)
        Line.BorderSizePixel = 0
			...
			if v.Name == "Flower2" or v.Name == "Flower1" then
				if FlowerESP then 
					if not v:FindFirstChild('NameEsp'..Number) then
						...
						name.BackgroundTransparency = 1
						name.TextStrokeTransparency = 0.5
						name.TextColor3 = Color3.fromRGB(140, 18, 222)
...
local Library = Update:Window("Matsune hub","",Enum.KeyCode.RightControl);
local File = Library:AddTab("Tab Info","4483345998")
local Main = Library:AddTab("Tab Farm","4483345998")
local M = Library:AddTab("Tab Item","4483345998")
local Sea = Library:AddTab("Tab Sea","4483345998")
local Ss = Library:AddTab("Tab Stats","4483345998")
local RaceV4 = Library:AddTab("Tab Race V4","4483345998")
local P = Library:AddTab("Tab Player","4483345998")
local R = Library:AddTab("Tab Dungeon","4483345998")
local T = Library:AddTab("Tab Teleport","4483345998")
local S = Library:AddTab("Tab Shopee","4483345998")
local D = Library:AddTab("Tab Fruit","4483345998")
...
File:AddLabel("Script PC/Mobile")
File:AddLabel("Wellcone To Script Matsune Hub V2")
File:AddLabel("Winter Hub Update Matsune Hub")
File:AddLabel("Link discrod me")
File:AddLabel("https://discord.com/invite/ksNWJX2A")

File:AddSeperator("Status")
    
    local locallv = File:AddLabel("Level")
    ...
    local localrace = File:AddLabel("Race")
    ...
    local localbeli = File:AddLabel("Beli")
    ...
    local localfrag = File:AddLabel("Fragment")
    ...
    local localexp = File:AddLabel("ExP")
    ...
    local localstat = File:AddLabel("Stats Points")
    ...
    local localbountyhornor = File:AddLabel("Bounty")
    ...
    local localDevil = File:AddLabel("Devil Fruit")
...
File:AddSeperator(" Sword ")

local Saber = File:AddLabel("❌: Saber")
local Rengoku = File:AddLabel("❌: Rengoku")
local Midnight_Blade = File:AddLabel("❌: Midnight Blade")
local Dragon_Trident = File:AddLabel("❌: Dragon Trident")
local Yama = File:AddLabel("❌: Yama")
local Buddy_Sword = File:AddLabel("❌: Buddy Sword")
local Canvander = File:AddLabel("❌: Canvander")
local Twin_Hooks = File:AddLabel("❌: Twin Hooks")
local Spikey_Trident = File:AddLabel("❌: Spikey Trident")
local Hallow_Scythe = File:AddLabel("❌: Hallow Scythe")
local Dark_Dagger = File:AddLabel("❌: Dark Dagger")
local Tushita = File:AddLabel("❌: Tushita")
...
File:AddSeperator("Quest")

local Bartilo_Quest = File:AddLabel("❌: Bartilo Quest")
local Don_Swan_Quest = File:AddLabel("❌: Don Swan Quest")
local Kill_Don_Swan = File:AddLabel("❌: Kill Don Swan")
...
File:AddSeperator("Sword Legendary")

local Shisui = File:AddLabel("❌: Shisui")
local Saddi = File:AddLabel("❌: Saddi")
local Wando = File:AddLabel("❌: Wando")
local True_Triple_Katana = File:AddLabel("❌: True Triple Katana")
...
File:AddSeperator("Melee")

local Superhuman = File:AddLabel("❌: Superhuman")
local Death_Step = File:AddLabel("❌: Death Step")
local Sharkman_Karate = File:AddLabel("❌: Sharkman Karate")
local Electric_Claw = File:AddLabel("❌: Electric Claw")
local Dragon_Talon = File:AddLabel("❌: Dragon Talon")
local God_Human = File:AddLabel("❌: God Human")
...
File:AddSeperator("Gun")

local Kabu_cha = File:AddLabel("❌: Kabucha")
local Acidum_Rifle = File:AddLabel("❌: Acidum Rifle")
local Bizarre_Rifle = File:AddLabel("❌: Bizarre Rifle")
...
File:AddSeperator("Accessory")

local Dark_Coat = File:AddLabel("❌: Dark Coat")
local Ghoul_Mask = File:AddLabel("❌: Ghoul Mask")
local Swan_Glass = File:AddLabel("❌: Swan Glass")
local Pale_Scarf = File:AddLabel("❌: Pale Scarf")
...
local Swan_Glass = File:AddLabel("❌: Swan Glass")
local Pale_Scarf = File:AddLabel("❌: Pale Scarf")
local Valkyrie_Helm = File:AddLabel("❌: Valkyrie Helm")
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "http://www.roblox.com/asset/?id=17314862794",
							Duration = 2.5
						})
					end
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep",true) == 1 then
...
print("Matsune Hub V3 Load Complete")

game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=17314862794";
      Title = "Matsune Hub V3", 
      Text = "hello Script Matsune";
      Button1 = "Okay"
})
wait(3)
game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=17314862794";
      Title = "Matsune Hub V3", 
      Text = "Thank you for using my hack";
       Button1 = "Okay"
})    